...
(function() {
  var Edge, Graph, Node, PebbleGraph, attachBindings, countOccurences, d3Vars, deleteNodes, disableDraw, drawEdge, drawGraph, drawInfinite, drawPebble, getColor, graphVars, hideHelp, initGraph, makePebbleGraph, matrixRank, nodeGenID, onClick, onClickEdge, onClickNode, onKeyDown, onKeyUp, onMouseDownEdge, onMouseDownNode, onMouseEnterNode, onMouseOutEdge, onMouseOutNode, onMouseUp, onMouseUpNode, redraw, resetGraphVars, showAbout, showHelp, toggleEdgeSelect, toggleNodeSelect, vars,
  ...
  onMouseOutNode = function() {
    ...
    graphVars.canAdd = true;
    graphVars.mouseOut = true;
    return graphVars.mouseEnter = false;
  };
