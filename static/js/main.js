...
(function() {
  var Edge, Graph, Node, PebbleGraph, d3Vars, drawGraph, graphVars, initGraph, nodeGenID, onClick, onMouseDown, onMouseDownNode, onMouseOutNode, onMouseUpNode, redraw, test, vars,
  ...
  drawGraph = function(graph, svg) {
    ...
    return svg.selectAll("circle").on("mousedown", onMouseDownNode).on("mouseup", onMouseUpNode).on("mouseout", onMouseOutNode);
  };
