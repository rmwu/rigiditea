...
(function() {
  var Edge, Graph, Node, PebbleGraph, d3Vars, drawGraph, graphVars, initGraph, nodeGenID, onClick, onClickNode, onMouseOutNode, redraw, test, vars,
  ...
  onMouseOutNode = function() {
    return graphVars.initNoS = false;
  };
  ...
  drawGraph = function(graph, svg) {
    ...
    return svg.selectAll("circle").on("mouseover", onClickNode).on("mouseout", onMouseOutNode);
  };
